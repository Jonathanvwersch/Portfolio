...
const Header = () => {
  ...
  return (
    <div className="w-full cursor-pointer fixed px-8 md:px-10 lg:px-12 py-6 z-100 bg-black select-none top-0 left-0 right-0 flex justify-between items-center">
      <Link to="/">
        <Logo />
      </Link>
      <div className="flex">
